        ...
        <nav className="auditeur-nav">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginTop: 10 }}>
            <Link
              ...
              style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', borderRadius: 10, border: '1.5px solid #e0e7ef', background: '#f8fafc', fontWeight: 600, fontSize: 16, boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}
            >
            ...
            <button onClick={() => setCreateOpen(true)} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', borderRadius: 10, border: '1.5px solid #bae6fd', background: '#f0f9ff', cursor: 'pointer', fontWeight: 600, fontSize: 16, boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>✉️ <span>Créer</span></button>
          </div>
        </nav>
      </aside>
